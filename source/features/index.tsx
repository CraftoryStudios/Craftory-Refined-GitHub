...
const globalReady: Promise<RGHOptions> = new Promise(async resolve => {
	...
	if (select.exists('html.craftory-refined-github')) {
		console.warn('Craftory Refined GitHub has been loaded twice. If you didn’t install the developer version, this may be a bug. Please report it.');
		return;
	}

	document.documentElement.classList.add('craftory-refined-github');
